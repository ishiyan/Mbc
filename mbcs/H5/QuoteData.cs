...
{
    /// <summary>
    /// Encapsulates the access to the instrument's Quote data.
    /// </summary>
    public sealed class QuoteData : Data
    {
        internal QuoteData(Instrument instrument, string dataName, IntPtr dataHandle) :
        ...
        public void Close()
        {
            ...
            {
                H5QuoteDataClose(dataHandle.Handle);
        ...
        {
            if (dataHandle.Handle != IntPtr.Zero)
                H5QuoteDataFlush(dataHandle.Handle);
        }

        /// <summary>
        /// The date and time ticks of the first data item.
        /// </summary>
        public long FirstTicks => dataHandle.Handle == IntPtr.Zero ? 0L : H5QuoteDataFirstTicks(dataHandle.Handle);

        /// <summary>
        /// The date and time ticks of the last data item.
        /// </summary>
        public long LastTicks => dataHandle.Handle == IntPtr.Zero ? 0L : H5QuoteDataLastTicks(dataHandle.Handle);

        /// <summary>
        /// The number of data items.
        /// </summary>
        public ulong Count => dataHandle.Handle == IntPtr.Zero ? 0L : H5QuoteDataCount(dataHandle.Handle);
        ...
        {
            get => dataHandle.Handle == IntPtr.Zero ? 0L : H5QuoteDataGetMaximumReadBufferBytes(dataHandle.Handle);
            set
            {
                if (dataHandle.Handle != IntPtr.Zero)
                    H5QuoteDataSetMaximumReadBufferBytes(dataHandle.Handle, value);
            }
        }
        ...
        public static bool SpreadDuplicateTimeTicks(Quote[] array, bool verbose)
        {
            // return NativeMethods.H5QuoteDataSpreadDuplicateTimeTicks(array, (ulong)array.LongLength, verbose);
            GCHandle handle = GCHandle.Alloc(array, GCHandleType.Pinned);
            bool status;
            try
            {
                status = H5QuoteDataSpreadDuplicateTimeTicks(handle.AddrOfPinnedObject(), (ulong)array.LongLength, verbose);
            }
            finally
            {
                handle.Free();
        ...
        public bool Add(Quote[] array, DuplicateTimeTicks duplicateTimeTicks, bool verbose)
        {
            return dataHandle.Handle != IntPtr.Zero && H5QuoteDataAdd(dataHandle.Handle, array, (ulong)array.LongLength, duplicateTimeTicks, verbose);
        }
        ...
        public delegate void Appender(long ticks, double askPrice, double bidPrice, double askSize, double bidSize);
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5QuoteDataFetchAll(dataHandle.Handle, appender);
        }
        ...
        /// <returns>A boolean indicating the success of the operation.</returns>
        public bool FetchAll(List<Quote> list)
        {
            void Appender(long ticks, double askPrice, double bidPrice, double askSize, double bidSize)
            {
                list.Add(new Quote
                {
                    Ticks = ticks,
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5QuoteDataFetchTickRange(dataHandle.Handle, appender, from.Ticks, to.Ticks);
        }
        ...
        /// <param name="to">An ending date and time.</param>
        /// <returns>A boolean indicating the success of the operation.</returns>
        public bool FetchTickRange(List<Quote> list, DateTime from, DateTime to)
        {
            void Appender(long ticks, double askPrice, double bidPrice, double askSize, double bidSize)
            {
                list.Add(new Quote
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5QuoteDataFetchIndexRange(dataHandle.Handle, appender, index, count);
        }
        ...
        /// <param name="count">The number of items in the range.</param>
        /// <returns>A boolean indicating the success of the operation.</returns>
        public bool FetchIndexRange(List<Quote> list, ulong index, ulong count)
        {
            void Appender(long ticks, double askPrice, double bidPrice, double askSize, double bidSize)
            {
                list.Add(new Quote
        ...
        public bool TicksIndex(long ticks, out ulong index, out bool match)
        {
            ...
            return H5QuoteDataTicksIndex(dataHandle.Handle, ticks, out index, out match);
        }
        ...
        public bool TicksIndexRange(long ticksFrom, long ticksTo, out ulong indexFrom, out ulong indexTo, out bool matchFrom, out bool matchTo)
        {
            ...
            return H5QuoteDataTicksIndexRange(dataHandle.Handle, ticksFrom, ticksTo, out indexFrom, out indexTo, out matchFrom, out matchTo);
        }
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5QuoteDataDeleteIndexRange(dataHandle.Handle, indexFrom, indexTo);
        }
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5QuoteDataDeleteTickRange(dataHandle.Handle, ticksFrom, ticksTo);
        }
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5QuoteDataDeleteAllBeforeTick(dataHandle.Handle, ticks);
        }
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5QuoteDataDeleteAllBeforeIndex(dataHandle.Handle, index);
        }
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5QuoteDataDeleteAllAfterTick(dataHandle.Handle, ticks);
        }
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5QuoteDataDeleteAllAfterIndex(dataHandle.Handle, index);
        }
    }
}

...
{
    /// <summary>
    /// Encapsulates the access to the instrument's OhlcvPriceOnly data.
    /// </summary>
    public sealed class OhlcvPriceOnlyData : Data
    {
        internal OhlcvPriceOnlyData(Instrument instrument, string dataName, IntPtr dataHandle) :
        ...
        public void Close()
        {
            ...
            {
                H5OhlcvPriceOnlyDataClose(dataHandle.Handle);
        ...
        {
            if (dataHandle.Handle != IntPtr.Zero)
                H5OhlcvPriceOnlyDataFlush(dataHandle.Handle);
        }

        /// <summary>
        /// The date and time ticks of the first data item.
        /// </summary>
        public long FirstTicks => dataHandle.Handle == IntPtr.Zero ? 0L : H5OhlcvPriceOnlyDataFirstTicks(dataHandle.Handle);

        /// <summary>
        /// The date and time ticks of the last data item.
        /// </summary>
        public long LastTicks => dataHandle.Handle == IntPtr.Zero ? 0L : H5OhlcvPriceOnlyDataLastTicks(dataHandle.Handle);

        /// <summary>
        /// The number of data items.
        /// </summary>
        public ulong Count => dataHandle.Handle == IntPtr.Zero ? 0L : H5OhlcvPriceOnlyDataCount(dataHandle.Handle);
        ...
        {
            get => dataHandle.Handle == IntPtr.Zero ? 0L : H5OhlcvPriceOnlyDataGetMaximumReadBufferBytes(dataHandle.Handle);
            set
            {
                if (dataHandle.Handle != IntPtr.Zero)
                    H5OhlcvPriceOnlyDataSetMaximumReadBufferBytes(dataHandle.Handle, value);
            }
        }
        ...
        public static bool SpreadDuplicateTimeTicks(OhlcvPriceOnly[] array, bool verbose)
        {
            // return NativeMethods.H5OhlcvPriceOnlyDataSpreadDuplicateTimeTicks(array, (ulong)array.LongLength, verbose);
            GCHandle handle = GCHandle.Alloc(array, GCHandleType.Pinned);
            bool status;
            try
            {
                status = H5OhlcvPriceOnlyDataSpreadDuplicateTimeTicks(handle.AddrOfPinnedObject(), (ulong)array.LongLength, verbose);
            }
            finally
            {
                handle.Free();
        ...
        public bool Add(OhlcvPriceOnly[] array, DuplicateTimeTicks duplicateTimeTicks, bool verbose)
        {
            return dataHandle.Handle != IntPtr.Zero && H5OhlcvPriceOnlyDataAdd(dataHandle.Handle, array, (ulong)array.LongLength, duplicateTimeTicks, verbose);
        }

        /// <summary>
        /// Callback function to append price-only ohlcv data items.
        /// </summary>
        ...
        public delegate void Appender(long ticks, double open, double high, double low, double close);
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5OhlcvPriceOnlyDataFetchAll(dataHandle.Handle, appender);
        }
        ...
        /// <returns>A boolean indicating the success of the operation.</returns>
        public bool FetchAll(List<OhlcvPriceOnly> list)
        {
            void Appender(long ticks, double open, double high, double low, double close)
            {
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5OhlcvPriceOnlyDataFetchTickRange(dataHandle.Handle, appender, from.Ticks, to.Ticks);
        }
        ...
        /// <param name="to">An ending date and time.</param>
        /// <returns>A boolean indicating the success of the operation.</returns>
        public bool FetchTickRange(List<OhlcvPriceOnly> list, DateTime from, DateTime to)
        {
            void Appender(long ticks, double open, double high, double low, double close)
            {
                list.Add(new OhlcvPriceOnly
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5OhlcvPriceOnlyDataFetchIndexRange(dataHandle.Handle, appender, index, count);
        }
        ...
        /// <param name="count">The number of items in the range.</param>
        /// <returns>A boolean indicating the success of the operation.</returns>
        public bool FetchIndexRange(List<OhlcvPriceOnly> list, ulong index, ulong count)
        {
            void Appender(long ticks, double open, double high, double low, double close)
            {
                list.Add(new OhlcvPriceOnly
        ...
        public bool TicksIndex(long ticks, out ulong index, out bool match)
        {
            ...
            return H5OhlcvPriceOnlyDataTicksIndex(dataHandle.Handle, ticks, out index, out match);
        }
        ...
        public bool TicksIndexRange(long ticksFrom, long ticksTo, out ulong indexFrom, out ulong indexTo, out bool matchFrom, out bool matchTo)
        {
            ...
            return H5OhlcvPriceOnlyDataTicksIndexRange(dataHandle.Handle, ticksFrom, ticksTo, out indexFrom, out indexTo, out matchFrom, out matchTo);
        }
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5OhlcvPriceOnlyDataDeleteIndexRange(dataHandle.Handle, indexFrom, indexTo);
        }
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5OhlcvPriceOnlyDataDeleteTickRange(dataHandle.Handle, ticksFrom, ticksTo);
        }
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5OhlcvPriceOnlyDataDeleteAllBeforeTick(dataHandle.Handle, ticks);
        }
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5OhlcvPriceOnlyDataDeleteAllBeforeIndex(dataHandle.Handle, index);
        }
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5OhlcvPriceOnlyDataDeleteAllAfterTick(dataHandle.Handle, ticks);
        }
        ...
        {
            return dataHandle.Handle != IntPtr.Zero && H5OhlcvPriceOnlyDataDeleteAllAfterIndex(dataHandle.Handle, index);
        }
    }
}

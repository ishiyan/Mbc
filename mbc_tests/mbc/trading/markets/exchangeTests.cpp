...
{
    using Exchange = mbc::trading::Exchange;
    using ExchangeCountry = mbc::trading::ExchangeCountry;
    using ExchangeMic = mbc::trading::ExchangeMic;
    using EuronextMic = mbc::trading::EuronextMic;
    ...
    TESTCASE("mic() returns value passed via copy constructor")
    {
        ...
        const Exchange exchange1{ expected };

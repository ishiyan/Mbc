...
INC=/I "..\shared" /I "$(MBC)\include" /I "$(DEPS)\include_hdf5" /I "$(DEPS)\include_zlib" /I "$(DEPS)\include_szip"
...
LINKFLAGS=$(LINKFLAGS) /OUT:"$(EXE)" /PDB:"$(BINNAME).pdb"

# -----------------------------------------------------------------------------------------------------
all: create_dirs $(EXE)

clean:
	if exist $(EXE) del /f /s /q $(EXE)
...
# -----------------------------------------------------------------------------------------------------
$(OBJDIR)\mbch5exp.obj: mbch5exp.cpp ..\shared\option_parser.h ..\..\mbc\include\mbc\h5.h
	cl $(CDEFS) $(INC) $(CFLAGS) /Fo"$(OBJDIR)\mbch5exp.obj" /c mbch5exp.cpp

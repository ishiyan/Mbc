...
# -----------------------------------------------------------------------------------------------------
$(OBJDIR)/mbch5ls.o: mbch5ls.cpp ../shared/option_parser.h ../../mbc/include/mbc/h5.h
	$(CXX) $(CXXDEFS) $(INC) $(CXXFLAGS) -o $(OBJDIR)/mbch5ls.o -c mbch5ls.cpp

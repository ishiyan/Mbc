...
# -----------------------------------------------------------------------------------------------------
$(OBJDIR)\mbch5ls.obj: mbch5ls.cpp ..\shared\option_parser.h ..\..\mbc\include\mbc\h5.h
	cl $(CDEFS) $(INC) $(CFLAGS) /Fo"$(OBJDIR)\mbch5ls.obj" /c mbch5ls.cpp
